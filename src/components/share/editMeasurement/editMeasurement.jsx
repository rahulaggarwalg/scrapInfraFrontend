...
export const EditMeasurement = ({setEditBanner,addCity,setPayload,payload,upDateCity}) => {
    let editBanner = {
        name:'',
        is_active:'',
    }
        ...
        <div className="modal-dialog modal-lg">
            <div className="modal-content">
                <div className="modal-header">
                    <h6 className="modal-title mt-0" id="myLargeModalLabel">{payload?'Update':'Add New'} Measurement</h6>
