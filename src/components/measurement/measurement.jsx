...
export const Measurement = ({weightList}) => {
  ...
  return (
    <>
        {weightModel  && <EditMeasurement upDateCity={upDateCity} payload={payload} addCity={addCity} setPayload={setPayload} setEditBanner={setWeightModel}/>}    
                            ...
                            <div className="card">  
                                ...
                                {showAlert && <Alert showAlert={showAlert} setShowAlert={setShowAlert} message={'<strong>Well done!</strong> 👍 You successfully Add City.'} showClass={'alert-success fade show'}/>}
                                    <div className="table-responsive">
                                        <div className="mb-2">
                                            <button className="btn btn-outline-primary btn-sm mb-1 mb-xl-0" id="reactivity-add" onClick={()=>{setWeightModel(!weightModel);setPayload('')}}>Add New Measurement</button>
                                        </div>
